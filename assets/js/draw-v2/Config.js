...
export const CONFIG = {
    ...
    ACTIVE_AFTER_MS: 45 * 60 * 1000,    // сколько ждём после (GitHub Action не мгновенный)

    /* ---------- фазы ---------- */

    LOCK_MS: 15 * 60 * 1000,            // T-15м: приём NFT закрыт (LOCKED)
    PRE_DRAW_MS: 30 * 1000,             // T-30с: PRE_DRAW, колесо раскручивается
    AWAIT_TIMEOUT_MS: 35 * 60 * 1000,   // сколько ждать публикацию, потом отпускаем
